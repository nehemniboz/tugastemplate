...
<head>
	...
	<link href="{{asset('gudang2/css/bootstrap.min.css')}}" rel="stylesheet">
	<link href="{{asset('gudang2/css/font-awesome.min.css')}}" rel="stylesheet">
	<link href="{{asset('gudang2/css/datepicker3.css')}}" rel="stylesheet">
	<link href="{{asset('gudang2/css/styles.css')}}" rel="stylesheet">
